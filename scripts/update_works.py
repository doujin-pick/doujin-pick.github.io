...
SOURCES = [
    ...
    # === Expansion toward ENRICH_LIMIT=4000 (page 3–5 + more splits) ===
    ...
    # === Expansion toward ENRICH_LIMIT=4000 (page 4–5 + niche types) ===
    ...
    # === Expansion toward ENRICH_LIMIT=4000 (page 6–8 + more niches) ===
    ...
    # === Expansion toward ENRICH_LIMIT=4000 (page 11–15 + deeper niches) ===
    ...
    # === Expansion toward ENRICH_LIMIT=4000 (page 16–20 + deeper ASMR/game/manga) ===
